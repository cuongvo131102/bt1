...
AS 
	...
	END
GO
dbo.NhapLieuHangSX 'H01', 'Samsung', 'California', '09011109089', 'Samsung.email'
GO
--- cau 2---
GO
...
AS
	...
	END
GO
dbo.NhapLieuSPmoi 'SP08', 'H03', 'Iphone 15 pro max', 2, 'Hong', 200000000, 'Chiec', 'Gioi Han'
GO
--- cau 3---
go
...
AS
	...
	END
GO
dbo.ChinhsuaNV 'NV04', 'Nguyễn Du', 'Nam', 'Hà Nội', '0355550000', 'ngdu1131@gmail.com', 'Ke toan', 0
GO
--- cau 5---
go
